<%-- 
    Document   : ExAdministrativa
    Created on : 25/06/2016, 11:48:23 PM
    Author     : Kiefer
--%>
...
<html>
    ...
    <body>
         <div class="container">
            ...
            <div class="tbcont">
                <table class="table table-bordered table-hover display responsive nowrap" id="tablaAdmi">
                    <thead>
                        <tr>
                            <th>Institucion</th>
        ...
        <script>
            $(document).ready(function () {
                $('#tablaAdmi').dataTable();
                listar();
                $('#insertAdmi').click(function (evt) {
                    var data = $('#forminsert').serialize();
                    data += "&docum=" + $('#docum').val();
                    var url = "../../adm?opc=addAdm";
                ...
                function listar() {
                    var tb = '<table class="table table-bordered table-hover display responsive nowrap" id="tablaAdm" width="100%">';
                    tb += '<thead><tr><th>Institucion</th><th>Cargo desempeñado</th><th>Regimen</th>';
                    tb += '<th>Fecha Inicio</th><th>Fecha Fin</th><th>Resolucion</th><th>Lugar</th>';
                    tb += '<th>Documentacion</th><th>Acciones</th></tr></thead><tbody id="tbodys"></tbody></table>';
                    var t = "";
                    var url = "../../adm?opc=listaAdm";
                    $.post(url, function (objJson) {
                        var list = objJson.listadm;
                        if (list.length > 0) {
