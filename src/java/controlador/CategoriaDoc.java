 ...
 * @author Kiefer
 */
public class CategoriaDoc extends HttpServlet {
private CatDocDao udao = new CatDocDao();
 Map<String, Object> rpta = new HashMap<String, Object>();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(opc.equals("listaCat")){
                ArrayList<Map<String,?>> listaCat= udao.listaCatDoc();
                rpta.put("listaCat", listaCat);
                
            }
            
            if (opc.equals("addCat")) {
